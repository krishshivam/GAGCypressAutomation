...
var configurePlugin = function (on) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        on('task', {
            query: function (args) {
                return execute_query(args).then(function (result) {
                    return result;
                });
            },
        });
...
function query(sql, values) {
    ...
    return cy.task('query', args).then(function (result) {
        return result;
    });
}
function execute_query(args) {
    return mysql.createConnection(args.db).then(function (connection) {
        var result = connection.query(args.sql, args.values).then(function (_a) {
            var result = _a[0];
            return result;
        });
        return connection.end().then(function () {
            return result;
        });
    });
}
